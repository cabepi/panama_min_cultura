        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex items-center">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 w-full pt-16 pb-12 md:py-0 h-full">
                ...
                <div
                    ...
                    <div
                        className="bg-white dark:bg-surface-dark rounded-2xl shadow-2xl overflow-hidden relative transition-transform duration-300 border border-slate-100 dark:border-slate-800">
                        ...
                        <div className="h-64 relative overflow-hidden flex items-start justify-center">
                            ...
                            <div className="absolute bottom-4 left-4 z-10">
                                <span id="featured-category"
                                    className="bg-white/20 backdrop-blur-md text-white px-3 py-1 rounded text-[10px] font-bold uppercase tracking-wider border border-white/30">Agentes
                                    Culturales</span>
                            </div>
                        </div>
                        ...
                        <div className="p-6">
                            <h3 id="featured-title"
                                ...
                                Karina E. González T.</h3>
                            <p id="featured-desc"
                                className="text-sm text-slate-500 dark:text-slate-400 line-clamp-2 mb-6 transition-opacity duration-300">
                                "Me dedico al diseño y confección de tembleques, preservando la tradición folclórica
                                panameña a través del arte."</p>
